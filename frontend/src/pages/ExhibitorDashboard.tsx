          ...
          <div className="mb-3">
            <div className="flex items-center justify-between mb-2 px-0.5">
              <div className="flex items-center gap-1.5">
                ...
                <p className="text-[9px] font-mono font-semibold uppercase tracking-[0.3em] text-zinc-500">Statistics</p>
              </div>
              <span className="text-[8px] font-mono text-zinc-600 uppercase tracking-widest hidden sm:inline">Overview</span>
            </div>
              ...
              <div className="bg-black border border-white/15 border-t-white/35 rounded-lg p-2.5 flex flex-row items-center justify-between relative overflow-hidden group hover:-translate-y-0.5 hover:border-white/35 hover:shadow-lg transition-all duration-300">
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-1 mb-0.5">
                    ...
                    <span className="text-[8px] font-mono uppercase tracking-[0.2em] text-zinc-400">Total Sales</span>
                  </div>
                  <div className="flex items-baseline">
                    <span className="text-[10px] font-light text-zinc-400 mr-0.5 font-mono">₱</span>
                    <span className="text-xl sm:text-2xl font-extralight tracking-tighter text-white">
                      {stats ? stats.sales.total.toLocaleString() : '0'}
                    </span>
                  </div>
                </div>
                <div className="relative z-10 text-right">
                  <span className="text-[7px] font-mono bg-white/[0.05] border border-white/10 px-1 py-0.5 rounded-full text-zinc-500 tracking-wider">REVENUE</span>
                  <p className="text-[8px] text-zinc-500 font-mono mt-1">{stats?.sales.count ?? artworks.filter(a => a.status === 'Sold').length} sold</p>
                </div>
              </div>
              ...
              <div className="bg-black border border-white/15 border-t-white/35 rounded-lg p-2.5 flex flex-row items-center justify-between relative overflow-hidden group hover:-translate-y-0.5 hover:border-white/35 hover:shadow-lg transition-all duration-300">
                <div className="relative z-10">
                  <div className="flex items-center gap-1 mb-0.5">
                    ...
                    <span className="text-[8px] font-mono uppercase tracking-[0.2em] text-zinc-400">Achievements</span>
                  </div>
                ...
                <div className="relative z-10 text-right">
                  <span className="text-[7px] font-mono bg-white/[0.05] border border-white/10 px-1 py-0.5 rounded-full text-zinc-500 tracking-wider">MILESTONES</span>
                  <p className="text-[8px] text-zinc-500 font-mono mt-1">{achievements.filter(a => a.isVerified).length} verified</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-4 gap-2">
              ...
              <div className="bg-black border border-white/[0.08] border-t-white/20 rounded-lg p-2 flex flex-col justify-between hover:-translate-y-0.5 hover:border-white/25 transition-all duration-200">
                ...
                <p className="text-base sm:text-lg font-light tracking-tight text-white leading-none">{stats?.total ?? artworks.length}</p>
                <span className="text-[7px] text-zinc-600 font-mono tracking-wide mt-0.5">total</span>
              </div>
              ...
              <div className="bg-black border border-white/[0.08] border-t-white/20 rounded-lg p-2 flex flex-col justify-between hover:-translate-y-0.5 hover:border-white/25 transition-all duration-200">
                ...
                <p className="text-base sm:text-lg font-light tracking-tight text-white leading-none">{artworks.filter(a => a.status === 'Available').length}</p>
                <span className="text-[7px] text-zinc-600 font-mono tracking-wide mt-0.5">listed</span>
              </div>
              ...
              <div className="bg-black border border-white/[0.08] border-t-white/20 rounded-lg p-2 flex flex-col justify-between hover:-translate-y-0.5 hover:border-white/25 transition-all duration-200">
                ...
                <p className="text-base sm:text-lg font-light tracking-tight text-white leading-none">{stats?.sales.count ?? artworks.filter(a => a.status === 'Sold').length}</p>
                <span className="text-[7px] text-zinc-600 font-mono tracking-wide mt-0.5">sold</span>
              </div>
              ...
              <div className="bg-black border border-white/[0.08] border-t-white/20 rounded-lg p-2 flex flex-col justify-between hover:-translate-y-0.5 hover:border-white/25 transition-all duration-200">
                ...
                <p className="text-sm sm:text-base font-light tracking-tight text-white leading-none truncate">
                ...
                <span className="text-[7px] text-zinc-600 font-mono tracking-wide mt-0.5">price</span>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-3xl lg:max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
          {notifications.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-16 sm:py-32 text-black dark:text-white">
              ...
              <p className="text-lg font-bold text-black dark:text-white">No notifications</p>
              <p className="text-sm mt-1 text-black dark:text-zinc-200">You're all caught up!</p>
            </div>
          ) : (
              ...
              {notifications.map(n => {
                ...
                return (
                  <div
                    ...
                    className={`flex items-start gap-4 p-5 rounded-2xl border transition-all duration-200 hover:shadow-md cursor-pointer ${ isUnread ? 'bg-white dark:bg-zinc-900 border-zinc-300 dark:border-zinc-700 shadow-sm' : 'bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800' }`}
                  >
                    <div className={`mt-0.5 w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${isUnread ? 'bg-black text-white' : 'bg-zinc-100 dark:bg-zinc-800 text-black dark:text-white'}`}>
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />
                      </svg>
                    </div>
                    <div className="flex-1 min-w-0">
                      <p className={`text-sm leading-relaxed text-black dark:text-white ${isUnread ? 'font-semibold' : 'font-normal'}`}>
                        <strong className="font-bold text-black dark:text-white">{n.title}</strong>: {n.message}
                      </p>
                      <p className="text-xs text-black dark:text-zinc-300 mt-1.5 font-medium">
